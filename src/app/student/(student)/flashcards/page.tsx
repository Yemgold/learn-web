...
// const PROGRESS_PREFIX = "jamb-league-flashcards-progress:";
...
// const biologyStats = useMemo(() => {
// const totalCards = biologyFlashcards.length;
...
// if (typeof window !== "undefined") {
//   biologyFlashcardDecks.forEach((deck) => {
//     const progress = getDeckProgress(deck);
...
//           <p className="mt-4 max-w-2xl text-sm leading-7 text-white/60 sm:text-base">
//             Study important JAMB concepts using focused
//             flashcards. Reveal answers, mark what you know,
//             review difficult cards, and track your progress
//             as you learn.
//           </p>
...
//         <div className="hidden lg:block">
//           <div className="relative h-52 w-52">
//             <div className="absolute inset-0 rounded-[2rem] rotate-6 border border-cyan-400/20 bg-cyan-400/5" />
...
//           <p className="mt-1 max-w-2xl text-sm text-white/45">
//             Select a topic to open its flashcard deck and
//             start learning.
//           </p>
//         </div>
...
//         </>
//       ) : (
//         <ComingSoon subject={selectedSubjectData.name} />
//       )}
//     </section>
...
//           <p className="mt-1 text-sm leading-6 text-white/45">
//             Short, repeated review sessions are more useful
//             than trying to memorize everything at once.
//             Mark difficult cards for review and return to
//             them regularly.
//           </p>
//         </div>
