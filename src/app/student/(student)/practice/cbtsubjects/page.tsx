...
function normalizeExamType(value: string | null): string {
  ...
  if (exam === "jamb" || exam === "waec" || exam === "neco") {
    return exam;
  }
...
export default function PracticePage() {
  ...
  const examType = normalizeExamType(searchParams.get("exam"));
      ...
      try {
        ...
        const mappedSubjects: Subject[] =
          backendSubjects.map((subject) => {
            const metadata =
              getSubjectMetadata(subject.name);
      ...
      const results =
        await Promise.allSettled(
          subjects.map(async (subject) => {
            const count =
              await getQuestionCount(subject._id);
  ...
  const currentSubjects = useMemo(() => {
    ...
    const allowedNames =
      classSubjectNames[selectedClass];
  ...
  }, [selectedSubject, currentSubjects]);
      ...
      <div className="relative z-10">
        <div className="container mx-auto max-w-6xl px-4 py-8 sm:py-10">
          ...
          <section className="mb-10">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-7 text-white/50 sm:text-base">
              Choose your academic class first, then select
              the subject you want to practise.
            </p>

            {examType && (
              <div className="mt-4 inline-flex items-center rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-xs font-bold uppercase tracking-wide text-white/70">
                {examDisplayName} Examination
              </div>
            )}

            {!examType && (
              <div className="mt-4 rounded-2xl border border-amber-400/20 bg-amber-500/10 px-4 py-3 text-sm font-medium text-amber-200">
                No examination type was provided. Please open
                this page with{" "}
                <code className="font-bold text-amber-100">
                  ?exam=jamb
                </code>
                ,{" "}
                <code className="font-bold text-amber-100">
          ...
          <section className="mb-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Card
              hoverable
              className="border-white/10 bg-white/[0.03] text-center text-white shadow-xl shadow-black/10 backdrop-blur-sm transition hover:border-white/20 hover:bg-white/[0.05]"
            >
              <BookOpen className="mx-auto h-9 w-9 text-blue-300" />
            ...
            <Card
              ...
              className="border-white/10 bg-white/[0.03] text-center text-white shadow-xl shadow-black/10 backdrop-blur-sm transition hover:border-white/20 hover:bg-white/[0.05]"
            >
              <Clock3 className="mx-auto h-9 w-9 text-orange-300" />
            ...
            <Card
              ...
              className="border-white/10 bg-white/[0.03] text-center text-white shadow-xl shadow-black/10 backdrop-blur-sm transition hover:border-white/20 hover:bg-white/[0.05]"
            >
              <BarChart3 className="mx-auto h-9 w-9 text-violet-300" />
          ...
          <section>
            <div className="mb-5">
              <div className="flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-600 text-sm font-bold text-white shadow-lg shadow-blue-600/20">
                  1
                </span>
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-white/40">
                    Select the class that contains the subject
                    you want to practise.
                  </p>
                </div>
              </div>
            ...
            <div className="grid gap-5 md:grid-cols-3">
              {(
                Object.entries(classes) as [
                  ClassType,
                  ClassConfig,
                ][]
              ).map(
                ([classType, classConfig]) => {
                  ...
                  return (
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        handleSelectClass(classType)
                      }
                      className={[
                        "group relative rounded-3xl border bg-white/[0.03] p-6 text-left transition-all duration-200",
                        "backdrop-blur-sm hover:-translate-y-1 hover:bg-white/[0.05]",
                    ...
                    >
                      {isSelected && (
                        <div className="absolute right-5 top-5 flex h-7 w-7 items-center justify-center rounded-full bg-blue-600 text-white shadow-lg shadow-blue-600/20">
                          <CheckCircle2 className="h-5 w-5" />
                        </div>
                      )}

                      <div
                        className={`flex h-14 w-14 items-center justify-center rounded-2xl border ${classConfig.iconBg}`}
                      >
                        <Icon
                          className={`h-7 w-7 ${classConfig.iconColor}`}
                        />
            ...
            <section className="mt-12">
              ...
              <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div>
                  ...
                  <p className="mt-2 pl-11 text-sm text-white/40">
                    {currentClass.name} subjects
                  </p>
                </div>

                <div className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-xs font-semibold text-white/50">
                  Select 1 subject
                </div>
              </div>
                ...
                <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                  {Array.from({ length: 5 }).map(
                    (_, index) => (
                      <Card
                        key={index}
                        className="animate-pulse border-white/10 bg-white/[0.03] p-6"
                      >
                        <div className="h-14 w-14 rounded-2xl bg-white/[0.08]" />

                        <div className="mt-6 h-6 w-2/3 rounded bg-white/[0.08]" />

                        <div className="mt-3 h-12 w-full rounded bg-white/[0.05]" />

                        <div className="mt-5 h-4 w-1/3 rounded bg-white/[0.08]" />
                      </Card>
                    ),
                  )}
                </div>
              ...
              {!loadingSubjects && subjectsError && (
                <Card className="border-red-400/20 bg-red-500/10 p-6">
                  ...
                  <Button
                    className="mt-4 bg-red-600 text-white hover:bg-red-500"
                    onClick={() =>
                      window.location.reload()
                    }
                  >
                      ...
                      (subject) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <h3 className="mt-6 pr-8 text-xl font-black text-white">
                              {subject.name}
                            </h3>
              ...
              {!loadingSubjects &&
                !subjectsError &&
                currentSubjects.length === 0 && (
                  <Card className="border-dashed border-white/15 bg-white/[0.02] p-10 text-center">
                    ...
                    <p className="mt-2 text-sm text-white/40">
                      No backend subjects were found for this
                      class.
                    </p>
                  </Card>
                )}
          ...
          {selectedSubjectData && (
            <section className="sticky bottom-4 z-20 mt-8">
              ...
              <Card className="border border-white/10 bg-slate-900/90 p-4 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-5">
                  ...
                  {subjectPracticeHref ? (
                    ...
                    >
                      <Button
                        ...
                        className="bg-blue-600 text-white shadow-lg shadow-blue-600/10 hover:bg-blue-500 sm:min-w-[220px]"
                      >
                        Continue to Practice
                      </Button>
                    </Link>
                    ...
                    <Button
                      ...
                      size="lg"
                      disabled
                      className="bg-white/[0.06] text-white/30 sm:min-w-[220px]"
                    >
                      Select an Exam
                    </Button>
                  )}
          ...
          {!selectedClass && (
            <section className="mt-10">
              ...
              <Card className="border-dashed border-white/15 bg-white/[0.02] p-8 text-center sm:p-12">
                ...
                <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-white/40">
                  Select Science, Commercial or Art Class
                  above to see the subjects available for
                  practice.
                </p>
              </Card>
            </section>
          ...
          <section className="mt-6">
            ...
            <Card className="flex flex-col gap-5 border-white/10 bg-white/[0.03] p-6 shadow-xl shadow-black/10 backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between">

              <div className="flex items-start gap-4">

                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-violet-400/20 bg-violet-500/10">
                  <BookMarked className="h-6 w-6 text-violet-300" />
                </div>
