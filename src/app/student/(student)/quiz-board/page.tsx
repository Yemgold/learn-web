...
export default function QuizBoardPage() {
  const [boards] = useState<QuizBoard[]>(MOCK_QUIZ_BOARDS);
  ...
  const liveBoards = boards.filter(
  ...
  const totalPlayers = boards.reduce(
    (total, board) => total + board.players,
    0,
  );
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-400 sm:text-base">
                Explore live and upcoming quiz battles. Pick a board,
                check the rules, and compete against other students
                for the top spot.
              </p>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-4 shadow-xl">
          ...
          {hasActiveFilters && (
            <div className="mt-3 flex items-center justify-between border-t border-white/10 pt-3">
              ...
              <p className="text-xs text-slate-500">
                Showing {filteredBoards.length} of{" "}
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-5 flex items-end justify-between gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Browse competitions and choose the one you want
              to view.
            </p>
