...
export default function ReferralsPage() {
  ...
  useEffect(() => {
    ...
    async function loadReferralData() {
      try {
        ...
        if (paidNetworkResponse.success) {
          setPaidNetwork(
            paidNetworkResponse.data,
          );
        }
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <div className="relative space-y-7 px-1 sm:space-y-8">
        {/* ========================================================
            HEADER
        ======================================================== */}
        ...
        {error && (
          <div className="mx-1 flex items-start gap-3 rounded-2xl border border-amber-200 bg-amber-50 px-5 py-4">
            <AlertCircle
              size={19}
              className="mt-0.5 shrink-0 text-amber-600"
            />
        ...
        <div className="grid gap-4 px-1 md:grid-cols-2 xl:grid-cols-4">
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-slate-950 p-5 text-white shadow-xl sm:p-6"
          >
            <div className="absolute -right-12 -top-12 h-32 w-32 rounded-full bg-blue-500/20 blur-2xl" />
        ...
        <motion.section
          ...
          className="mx-1 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6"
        >
          <div>
            <h2 className="text-lg font-bold text-slate-900">
              Referral Network
        ...
        <motion.section
          ...
          className="mx-1 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm"
        >
          ...
          {referrals.length === 0 ? (
            <div className="flex flex-col items-center justify-center px-5 py-12 text-center sm:px-6 sm:py-16">
              ...
              <button
                ...
                onClick={shareReferral}
                disabled={!referralLink}
                className="mt-5 inline-flex items-center gap-2 rounded-2xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
              >
                <Share2 size={17} />
                Invite Someone
              </button>
              ...
              {referrals.map(
                (referral) => {
                  ...
                  return (
                    <div
                      key={referral.id}
                      className="mx-1 flex items-center justify-between gap-3 rounded-xl px-4 py-4 transition hover:bg-slate-50 sm:mx-2 sm:px-4 sm:py-4"
                    >
        ...
        <div className="mx-1 flex items-start gap-3 rounded-2xl border border-blue-100 bg-blue-50 px-4 py-3.5">
          <Clock3
            size={18}
            className="mt-0.5 shrink-0 text-blue-600"
          />
