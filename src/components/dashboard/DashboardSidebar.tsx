...
export default function DashboardSidebar({
  ...
  /*
   * Students without a SECONDARY plan receive
   * 30 days of free access starting from their
   * original registration date.
   *
   * The trial does NOT restart when they visit
   * the Free plan page.
   */
  ...
  /*
   * A student has Secondary access if:
   *
   * 1. They have a SECONDARY plan, OR
   * 2. They are still inside their 30-day free trial.
   */
  ...
  const isItemAccessible = (
     ...
     * Student has either:
     *
     * - an active SECONDARY plan, OR
     * - an active 30-day free trial.
     */
    ...
    /*
     * Student has no active plan and
     * their free trial has expired.
     *
